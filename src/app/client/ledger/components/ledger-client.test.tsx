                ...
                balances={[
                    {
                        ...
                        product: { id: "prod-1", name: "Portland Cement", description: "Cement", bag_type: "JB", price_per_bag: 250, price_port: null, price_warehouse: null, image_url: null, is_active: true, created_at: new Date().toISOString() },
                        order: {
                ...
                balances={[
                    {
                        ...
                        status: "pending",
                        created_at: new Date().toISOString(),
                        product: { id: "prod-2", name: "Portland Cement", description: "Cement", bag_type: "SB", price_per_bag: 250, price_port: null, price_warehouse: null, image_url: null, is_active: true, created_at: new Date().toISOString() },
                        order: {
                ...
                balances={[
                    {
                        ...
                        status: "pending",
                        created_at: new Date().toISOString(),
                        product: { id: "prod-3", name: "Portland Cement", description: "Cement", bag_type: "JB", price_per_bag: 250, price_port: null, price_warehouse: null, image_url: null, is_active: true, created_at: new Date().toISOString() },
                        order: {
