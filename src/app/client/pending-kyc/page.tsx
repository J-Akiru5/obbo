                    ...
                    <CardContent className="pt-5 pb-5 space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="space-y-1">
                                <p className="text-sm font-semibold text-amber-900">What&apos;s locked?</p>
                        ...
                        <div className="border-t border-amber-200 pt-4 flex items-start gap-3">
                        ...
                        <div className="border-t border-amber-200 pt-3">
                            <p className="text-xs text-amber-700">
                                ⏱ Accounts are typically reviewed within <span className="font-semibold">1–2 business days</span>.
