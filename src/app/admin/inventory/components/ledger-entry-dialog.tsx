    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            {entry
              ? 'Update the details of this ledger row.'
              : 'Add a manual ledger entry to this shipment batch.'}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1.5">
              <Label className="text-xs" htmlFor="ledger-date">
                Date
              </Label>
              <Input
                id="ledger-date"
            ...
            <div className="space-y-1.5">
              <Label className="text-xs" htmlFor="ledger-po">
                PO #
              </Label>
              <Input
                id="ledger-po"
            ...
            <div className="space-y-1.5">
              <Label className="text-xs" htmlFor="ledger-dr">
                DR #
              </Label>
              <Input
                id="ledger-dr"
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1.5">
              <Label className="text-xs" htmlFor="ledger-client">
                Client Name
              </Label>
              <Input
                id="ledger-client"
            ...
            <div className="space-y-1.5">
              <Label className="text-xs" htmlFor="ledger-driver">
                Driver Name
              </Label>
              <Input
                id="ledger-driver"
            ...
            <div className="space-y-1.5">
              <Label className="text-xs" htmlFor="ledger-plate">
                Plate #
              </Label>
              <Input
                id="ledger-plate"
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="col-span-2 space-y-1.5">
              <Label className="text-xs" htmlFor="ledger-destination">
                Destination
              </Label>
              <Input
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={form.jb || ''}
                placeholder="0"
                onChange={(e) => set('jb', parseInt(e.target.value) || 0)}
                className="h-9"
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={form.sb || ''}
                placeholder="0"
                onChange={(e) => set('sb', parseInt(e.target.value) || 0)}
                className="h-9"
              />
            </div>
            <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            {form.payment_method === 'check' && (
              <div className="space-y-1.5">
                <Label className="text-xs" htmlFor="ledger-check-no">
                  Check No.
                </Label>
                <Input
                  id="ledger-check-no"
            ...
            <div className="space-y-1.5">
              <Label className="text-xs" htmlFor="ledger-amount">
                Amount (₱)
              </Label>
              <Input
                id="ledger-amount"
          ...
          <div className="border-t pt-3">
            ...
            <div className="grid grid-cols-4 gap-3">
              <div className="space-y-1.5">
                <Label className="text-xs" htmlFor="ledger-bags-returned">
                  Bags Returned
                </Label>
                <Input
                  id="ledger-bags-returned"
                  type="number"
                  min={0}
                  value={form.bags_returned || ''}
                  placeholder="0"
                  onChange={(e) => set('bags_returned', parseInt(e.target.value) || 0)}
                  className="h-9"
                />
              </div>
              <div className="space-y-1.5">
                ...
                {(() => {
                  ...
                  return (
                    <Select
                      ...
                      value={form.bag_returned_type || ''}
                      onValueChange={(v) => set('bag_returned_type', v)}
                      disabled={!Number(form.bags_returned)}
                    >
                      <SelectTrigger className="h-9">
              ...
              <div className="space-y-1.5">
                ...
                {(() => {
                  ...
                  return (
                    <Select
                      items={reasonOptions}
                      value={form.return_reason || 'return'}
                      onValueChange={(v) => set('return_reason', v)}
                      disabled={!Number(form.bags_returned)}
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue />
            ...
            {Number(form.bags_returned) > 0 && (
              <p
                className={`mt-2 text-xs ${form.return_reason === 'return' ? 'text-emerald-600' : 'text-red-600'}`}
              >
          ...
          {Number(form.bags_returned) > 0 && (
            <div className="space-y-1.5">
              ...
              <Input
                value={form.client_reason || ''}
                onChange={(e) => set('client_reason', e.target.value)}
                placeholder="Optional: reason from client or additional notes"
                className="h-9"
              />
            </div>
          )}
          ...
          {/* Notes */}
          <div className="space-y-1.5">
            <Label className="text-xs" htmlFor="ledger-notes">
              Notes
            </Label>
            <Input
              id="ledger-notes"
