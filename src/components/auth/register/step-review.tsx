...
export function StepReview({ form, files, onEditStep, onSubmit, loading }: StepReviewProps) {
    ...
    <div className="space-y-5">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground text-sm">
          Please review your information before submitting. Click &ldquo;Edit&rdquo; on any section
          to make changes.
        </p>
      </div>
          ...
          {isCompany ? (
            <>
              ...
              <ReviewField
                ...
                value={`${form.contact_person_first_name} ${form.contact_person_surname}`}
              />
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
        ...
        <p className="mt-1 leading-relaxed">
          After submission, your account will be created with pending verification status. An
          administrator will review your details and documents before granting full portal access.
        </p>
      </div>
      ...
      <div className="flex justify-end">
        <Button
          type="button"
          className="h-12 gap-2 bg-emerald-600 px-8 font-semibold text-white hover:bg-emerald-700"
          onClick={onSubmit}
          disabled={loading}
        >
          {loading ? (
